...
interface DashboardListItemStatProps {
  name: string;
  value: string | number;
}

const DashboardListItemStat: React.FC<DashboardListItemStatProps> = ({ name, value }): JSX.Element => {
  return (
...
export default DashboardListItemStat;
